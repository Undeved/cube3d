...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_shared_textures_utils.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: oimzilen <oimzilen@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/10 03:28:59 by oimzilen          #+#    #+#             */
/*   Updated: 2025/11/10 03:42:48 by oimzilen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cube.h"

static void	load_shared_animation_frame(t_parsed_data *pd,
	t_raw_img *frames, char **paths, int count)
{
	int	i;
