...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/05 23:13:20 by oukhanfa          #+#    #+#             */
/*   Updated: 2025/11/06 02:15:34 by oukhanfa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(void)direction;
	alternatives[0].x = 1.0;
	alternatives[0].y = 0.0;
	alternatives[1].x = -1.0;
	alternatives[1].y = 0.0;
	alternatives[2].x = 0.0;
	alternatives[2].y = 1.0;
	alternatives[3].x = 0.0;
	alternatives[3].y = -1.0;
}
