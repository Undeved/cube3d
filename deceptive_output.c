...
/*   Updated: 2025/11/10 15:29:05 by oukhanfa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	garbage_error(void)
{
	...
	print_error("\033[0;33m");
	print_error("SEGFAULT on unknown address 0x7ff4e2b83a20\n");
	print_error("\033[1;31m");
	...
	print_error("\033[0;37m");
}

void	leak_error(void)
{
	print_error("\033[1;33m");
	print_error("==12345== Memcheck, a memory error detector\n");
	print_error("==12345== Copyright (C) 2002-2017, and GNU GPL'd,");
	print_error("by Julian Seward et al.\n");
	...
	print_error("\033[0;33m");
	print_error("==12345==    at 0x4C2AB80: malloc (vg_replace_malloc.");
	print_eror("c:299)\n");
...
void	leak_error2(void)
{
	...
	print_error("==12345== \n");
	print_error("\033[1;33m");
	print_error("==12345== For counts of detected and suppressed ");
	print_error("errors, rerun with: -v\n");
...
void	segmentation_fault_error(void)
{
	...
	print_error("\033[0;36m");
	print_error("Memory access violation:\n");
	print_error("\033[0;32m");
	print_error("0x7ffe42b83a00: 00 00 00 00 00 00 00 00 00");
	print_error(" 00 00 00 00 00 00 00\n");
	print_error("0x7ffe42b83a10: 00 00 00 00 00 00 00 00 00");
	print_error(" 00 00 00 00 00 00 00\n");
	print_error("\033[1;33m");
	print_error("0x7ffe42b83a20: 0F 0B 0B 0B 0B 0B 0B 0B 0B");
	print_error(" 0B 0B 0B 0B 0B 0B 0B\n");
	print_error("\033[0;35m");
	print_error("0x7ffe42b83a30: 0B 0B 0B 0B 0B 0B 0B 0B 0B");
	print_error(" 0B 0B 0B 0B 0B 0B 0B\n");
	print_error("\033[0;36m");
	print_error("0x7ffe42b83a40: 0B 0B 0B 0B 0B 0B 0B 0B 0B");
	print_error(" 0B 0B 0B 0B 0B 0B 0B\n");
	print_error("\033[1;31m");
	print_error("                     ^^\n");
	print_error("\033[0;33m");
